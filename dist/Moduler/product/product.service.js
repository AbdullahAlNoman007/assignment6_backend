...
const getAProductFromDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.productModel.findById(payload);
    return result;
});
...
const getProductFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield filterQuery.skip(skip).limit(limit);
    const total = yield product_model_1.productModel.countDocuments();
    const meta = {
        total
    };
    return { meta, result };
